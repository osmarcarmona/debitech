export const translations = {
  en: {
    ...
    confirmDeleteLoan: 'Are you sure you want to delete this loan? This will also delete all associated payments. This action cannot be undone.',
    ...
    noInterestAccrued: 'No interest has accrued yet',
    total: 'Total',
  ...
  es: {
    ...
    confirmDeleteLoan: '¿Está seguro de que desea eliminar este préstamo? Esto también eliminará todos los pagos asociados. Esta acción no se puede deshacer.',
    ...
    capitalPayment: 'Pago a Capital',
    interestPayment: 'Pago de Interés',
    ...
    noInterestAccrued: 'No se ha acumulado interés aún',
    total: 'Total',
    cycleDates: 'Fechas Ciclo',
